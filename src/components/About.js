...
export default function About() {
  ...
  const [btnclass, setBtnclass] = useState("btn btn-outline-dark")
  const ToggleMode =()=>{
   
    if(mystyle.color==='white'){
      setBtnclass("btn btn-outline-dark")
      ...
      setBtnclass("btn btn-outline-info")
  ...
  <div className="accordion-item">
    ...
    <div id="panelsStayOpen-collapseThree" className="accordion-collapse collapse">
      ...
      <div>
        <button className={btnclass} onClick={ToggleMode}>{btntext}</button>
